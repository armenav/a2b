...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ridesearch.passanger_number'
        db.delete_column(u'main_ridesearch', 'passanger_number')


    def backwards(self, orm):
        # Adding field 'Ridesearch.passanger_number'
        db.add_column(u'main_ridesearch', 'passanger_number',
